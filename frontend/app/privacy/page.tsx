      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="space-y-6 text-muted-foreground">
          <section className="space-y-4">
            ...
            <p>
              Charis ("we," "our," or "us") is committed to protecting your
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong className="text-foreground">Personal Data:</strong> When
                you create an account, we collect your email address, username,
                . You may also choose to provide additional information such as
                profile pictures and biographical information.
              </li>
              <li>
                <strong className="text-foreground">Prayer Content:</strong> We
                collect the prayer requests, comments, and messages you submit
                through the Platform.
              </li>
              <li>
                <strong className="text-foreground">Usage Data:</strong> We
                automatically collect information about your interactions with
                the Platform, including the pages you visit, the features you
                use, and the time spent on the Platform.
              </li>
              <li>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>To facilitate prayer sharing and community interactions</li>
              <li>
                To send you notifications about prayer requests, comments, and
                messages
              </li>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                ...
                Your prayer requests, comments, and profile information may be
                visible to other users of the Platform, depending on your
                privacy settings.
              </li>
              <li>
                ...
                provide services on our behalf, such as hosting, data analysis,
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                ...
                You can update or delete your account information through your
                account settings.
              </li>
              <li>
                <strong className="text-foreground">Prayer Requests:</strong>{" "}
                You can edit or delete your prayer requests through the
                Platform.
              </li>
              <li>
                <strong className="text-foreground">Notifications:</strong> You
                can manage your notification preferences in your account
                settings.
              </li>
              <li>
                <strong className="text-foreground">Cookies:</strong> Most web
                browsers are set to accept cookies by default. You can usually
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              contact us at privacy@charis.com.
            </p>
          </section>
        </div>
      </div>
